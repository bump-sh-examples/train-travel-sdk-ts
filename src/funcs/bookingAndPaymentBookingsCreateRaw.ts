 ...
 */
export function bookingAndPaymentBookingsCreateRaw(
  ...
  Result<
    operations.CreateBookingRawResponse,
    | TrainTravelSDKError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateBookingRawResponse$inboundSchema, {
      key: "Result",
    }),
    M.bytes(201, operations.CreateBookingRawResponse$inboundSchema, {
