...
export function createBookingPaymentRequestFromJSON(
  jsonString: string,
): SafeParseResult<CreateBookingPaymentRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateBookingPaymentRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateBookingPaymentRequest' from JSON`,
  );
}
...
export function createBookingPaymentResponseBodyToJSON(
  createBookingPaymentResponseBody: CreateBookingPaymentResponseBody,
): string {
  return JSON.stringify(
    CreateBookingPaymentResponseBody$outboundSchema.parse(
      createBookingPaymentResponseBody,
    ),
  );
}
...
export function createBookingPaymentResponseToJSON(
  createBookingPaymentResponse: CreateBookingPaymentResponse,
): string {
  return JSON.stringify(
    CreateBookingPaymentResponse$outboundSchema.parse(
      createBookingPaymentResponse,
    ),
  );
}
