 ...
 * Links to the next and previous pages of a paginated response.
 */
export type GetStationsStationsLinks = {
  self?: string | undefined;
  next?: string | undefined;
  prev?: string | undefined;
};
...
export type GetStationsResponseBody = {
  data?: Array<components.Station> | undefined;
  links?: GetStationsStationsLinks | undefined;
};
...
/** @internal */
export const GetStationsStationsLinks$inboundSchema: z.ZodType<
...
export function getStationsStationsLinksFromJSON(
  jsonString: string,
): SafeParseResult<GetStationsStationsLinks, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetStationsStationsLinks$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetStationsStationsLinks' from JSON`,
  );
}
...
> = z.object({
  data: z.array(components.Station$inboundSchema).optional(),
  links: z.lazy(() => GetStationsStationsLinks$inboundSchema).optional(),
});
