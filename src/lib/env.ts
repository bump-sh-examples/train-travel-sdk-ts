...
export interface Env {
  TRAINTRAVELSDK_O_AUTH2?: string | undefined;

  TRAINTRAVELSDK_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  TRAINTRAVELSDK_O_AUTH2: z.string().optional(),

  TRAINTRAVELSDK_DEBUG: z.coerce.boolean().optional(),
});
