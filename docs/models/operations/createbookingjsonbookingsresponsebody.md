...
```typescript
import { CreateBookingJsonBookingsResponseBody } from "train-travel-sdk/models/operations";

let value: CreateBookingJsonBookingsResponseBody = {
...
| `tripId`                                                     | *string*                                                     | :heavy_check_mark:                                           | Identifier of the booked trip                                | 4f4e4e1-c824-4d63-b37a-d8d698862f1d                          |
